...
alter table Payment add foreign key (customerID) references Customers(customerID); 
 ...
 -- Admins
insert into Admins(adminID,firstName,lastName,emailID,password,phone) values('admin1','Huy','Vu','vu@gmail.com','123',0902968720);
insert into Admins(adminID,firstName,lastName,emailID,password,phone) values('admin2','Thai','Bao','bao@gmail.com','123',0902968721);
 insert into Admins(adminID,firstName,lastName,emailID,password,phone) values('admin3','Ba','Vuong','vuong@gmail.com','123',0902968722);
